...
class Option {
	...
	static function getWidgetTitle() {
		$widget_title = array(
			'blogger' => langs('blogger'),
			'calendar' =>langs('calendar'),
			'twitter' => langs('twitter_latest'),
			'tag' =>langs('tags'),
			'sort' => langs('category'),
			'archive' =>langs('archive'),
			'newcomm' => langs('new_comments'),
			'newlog' => langs('new_posts'),
			'random_log' => langs('random_post'),
			'hotlog' => langs('hot_posts'),
			'link' =>langs('links'),
			'search' => langs('search'),
			'custom_text' => langs('widget_custom')
		);
		return $widget_title;
	}
