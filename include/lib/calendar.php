...
class Calendar {
	...
	static function generate() {
		...
		<tr><td class=\"week\">".langs('weekday1')."</td><td class=\"week\">".langs('weekday2')."</td><td class=\"week\">".langs('weekday3')."</td><td class=\"week\">".langs('weekday4')."</td><td class=\"week\">".langs('weekday5')."</td><td class=\"week\">".langs('weekday6')."</td><td class=\"sun\">".langs('weekday7')."</td></tr>";
