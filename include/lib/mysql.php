    ...
    private function __construct() {
        ...
        if (!$this->conn = @mysql_connect(DB_HOST, DB_USER, DB_PASSWD)) {
            switch ($this->geterrno()) {
                case 2005:
                    emMsg(langs('db_database_unavailable'));
                    break;
                case 2003:
                ...
                case 2006:
                    ...
                    break;
                case 1045:
                    emMsgs(langs('db_credential_error'));
                    break;
                default :
                    emMsg(langs('db_error_code') . $this->geterrno());
                    break;
            }
        }
        ...
        @mysql_select_db(DB_NAME, $this->conn) OR emMsg(langs('db_not_found'));
    }
