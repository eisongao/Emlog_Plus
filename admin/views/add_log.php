...
<div class="heading-bg  card-views">
 ...
 <?php echo langs('home') ?></a>
 </li>
 <li class="active">
 <?php echo langs('post_write')?>
 </li>
 </ul>
</div>
<div id="msg_2"></div>
...
<div id="post_button">
    ...
    <input type="hidden" name="ishide" id="ishide" value="">
       <input type="hidden" name="author" id="author" value=<?php echo UID; ?> />
        <input type="submit" value="<?php echo langs('post_publish')?>" onclick="return checkform();" class="btn btn-primary" />
        <input type="button" name="savedf" id="savedf" value="<?php echo langs('save_draft')?>" onclick="autosave(2);" class="btn btn-success"/>
</div>           
</div>
</div>
</div>	
