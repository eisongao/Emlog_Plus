...
<span id="asmsg"></span>
 ...
 <iframe width="100%" height="180px"  frameborder="0" src="attachment.php?action=attlib&logid=<?php echo $pageId; ?>"></iframe>
 </div>    
 <?php endif; ?>
 </div>            		
 <?php if(Option::get('admin_editor') == 3){?>
...
<input maxlength="200" class="form-control" name="template" id="template" value="<?php echo $template;?>" placeholder="<?php echo langs('page_template_info')?>"/> 
</div>
 <div class="form-group">
